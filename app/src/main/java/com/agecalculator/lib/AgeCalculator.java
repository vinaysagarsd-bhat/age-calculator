...
public class AgeCalculator {
     ...
     */
         ...
         * @param totalDay
         */
        public AgeCalculator(int year, int month, int day, int totalDay) {
            this.year = year;
            this.month = month;
            this.day = day;
         ...
         */
        public static AgeCalculator calculateAge(Calendar startDate, Calendar endDate) {
            ...
            return new AgeCalculator(mYearDiff, mMonDiff, mDayDiff, totalDays);
        }
